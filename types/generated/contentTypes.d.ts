...
export interface ApiLawyersPageLawyersPage extends Struct.SingleTypeSchema {
  collectionName: 'lawyers_pages';
  info: {
    displayName: 'Lawyers-pages';
    pluralName: 'lawyers-pages';
    singularName: 'lawyers-page';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::lawyers-page.lawyers-page': ApiLawyersPageLawyersPage;
